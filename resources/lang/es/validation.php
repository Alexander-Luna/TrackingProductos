...
return [
    ...
    | by the validator class. Some of these rules have multiple versions such
    ...
    */
    ...
    'password.confirm'     => 'La confirmación de la contraseña no coincide.',
    'pattern'              => 'El formato del campo :attribute no es válido.',
    ...
    'unique'               => 'El :attribute ya ha sido registrado.', // <-- Aquí está la traducción para 'unique'
    ...
    |--------------------------------------------------------------------------
    |
    | Here you may specify custom validation rules for your application in order
    | to make messages more expressive.
    |
    */
    ...
    */
    ...
    'attributes' => [
        'ci'  => 'Número de cédula', // <-- Asegúrate de tener esto para traducir el nombre del campo
        'dni' => 'Número de DNI', // Si usas 'dni' directamente en tus reglas
        // Otros atributos...
    ],
